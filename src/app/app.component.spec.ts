...
describe('AppComponent', () => {
  ...
  it('should call getOffQuote function from service', () => {
    const spy = spyOn(quoteService, 'getOfficeQuote').and.returnValue(of(quoteWrapper));
    component.getQuote();
  ...
  it('should locate quote element on page if quote data is present', () => {
    ...
    const quoteEl = fixture.debugElement.queryAll(By.css('.container__elements-quote'))[0].nativeElement;
